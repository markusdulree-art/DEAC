...
Result Engine::evaluate() const {
    ...
    // A family only counts as supporting when its fused score crosses the monitor
    // threshold. Merely observing a family must never satisfy the independence
    // requirement.
    result.supporting_families = 0;
